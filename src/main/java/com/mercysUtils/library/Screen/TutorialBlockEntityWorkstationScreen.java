...
public class TutorialBlockEntityWorkstationScreen extends AbstractContainerScreen<TutorialBlockEntityWorkstationMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MercysUtils.MOD_ID, "textures/gui/tutorial_crafting_workstation_gui.png");

    public TutorialBlockEntityWorkstationScreen(TutorialBlockEntityWorkstationMenu menu, Inventory inventory, Component title) {
