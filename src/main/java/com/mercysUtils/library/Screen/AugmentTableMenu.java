...
import com.mercysUtils.library.Screen.Slots.AugmentSlots;
import com.mercysUtils.library.Screen.Slots.ToolSlot;
...
public class AugmentTableMenu extends AbstractContainerMenu {

    public final AugmentTableEntityClass blockEntity;
    ...
    public AugmentTableMenu(int containerId, Inventory inventory, BlockEntity entity, ContainerData data){
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            // Main tool/armor slot (center)
            this.addSlot(new ToolSlot(iItemHandler, 0, 80, 35));

            // Two augment slots (left and right, for example)
            this.addSlot(new AugmentSlots(iItemHandler, 1, 50, 35));
            this.addSlot(new AugmentSlots( iItemHandler, 2, 110, 35));
...
//                player, ModBlocks.AUGMENT_TABLE_BLOCK.get());
        return true;
    }
