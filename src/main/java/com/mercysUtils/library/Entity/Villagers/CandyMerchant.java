package com.mercysUtils.library.Entity.Villagers;// Made with Blockbench 5.0.2
...
public class CandyMerchant<T extends AbstractVillager> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "candymerchant"), "main");
	...
	public CandyMerchant(ModelPart root) {
